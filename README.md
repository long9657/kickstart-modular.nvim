...
```sh
git clone https://github.com/long9657/kickstart-modular.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/long9657/kickstart-modular.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/long9657/kickstart-modular.nvim.git "${env:LOCALAPPDATA}\nvim"
```
